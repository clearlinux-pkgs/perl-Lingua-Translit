...
Source0  : https://cpan.metacpan.org/authors/id/A/AL/ALINKE/Lingua-Translit-0.29.tar.gz
...
%prep
%setup -q -n Lingua-Translit-0.29
cd %{_builddir}
tar xf %{_sourcedir}/liblingua-translit-perl_0.28-1.debian.tar.xz
cd %{_builddir}/Lingua-Translit-0.29
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Lingua-Translit-0.29/deblicense/
